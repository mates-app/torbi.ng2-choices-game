...
var GameOverComponent = (function () {
    function GameOverComponent(gameControl) {
        var _this = this;
        this.gameControl = gameControl;
        this.effectivity = 0;
        this.gameControl.runEffectivity().subscribe(function (value) { return _this.effectivity = value; });
    }
    GameOverComponent.prototype.runEffectivity = function () {
    };
    __decorate([
        core_1.Input(), 
