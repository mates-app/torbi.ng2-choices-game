...
var ChoiceGameTest = (function () {
    function ChoiceGameTest(gameControl) {
        ...
        this.gameProblem = new models_1.GameProblem('2 + 4', ['2', '6', '10'], ['6']);
...
var MdProgressCircleFake = (function () {
    function MdProgressCircleFake() {
    }
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], MdProgressCircleFake.prototype, "value", void 0);
    MdProgressCircleFake = __decorate([
        core_1.Directive({
            selector: 'md-progress-circle'
        }), 
        __metadata('design:paramtypes', [])
    ], MdProgressCircleFake);
    return MdProgressCircleFake;
}());
exports.MdProgressCircleFake = MdProgressCircleFake;
